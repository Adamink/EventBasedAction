...
rootCodeFolder = '/mnt/data1/wuxiao/codes/summer/data_preparation/DHP19'; % root directory of the git repo.
...
for subj = 1:numSubjects 
    ...
    for sess = 1:numSessions
        ...
        for mov = 1:numMovements
            ...
            outDVSfile = strcat(subj_string,'_',sessString,'_',movString,'_','raw');
